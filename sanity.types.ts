...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | YandexGoal | Breadcrumbs | AllPosts | FormRegister | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | GridRow | GridProduct | GridPost | PricingCard | GridCard | SplitInfo | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitInfoList | SplitRow | SectionHeader | Hero2 | Hero1 | Statistics | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Product | UserAccount | Testimonial | Faq | Category | Post | Author | Page | Slug | SiteSettings | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | ContactInfo | Code;
