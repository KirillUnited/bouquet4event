...
export type BenefitsType = Array<{
  title?: string;
  description?: string;
  icon?: string;
  _key: string;
...
export type ContactInfo = {
  ...
  workingHours?: string;
  socialLinks?: Array<{
    platform?: "instagram" | "telegram" | "viber" | "whatsapp";
    url?: string;
    _key: string;
  }>;
};
...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | Geopoint | YandexGoal | Breadcrumbs | AllPosts | FormRegister | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | GridRow | GridProduct | GridPost | PricingCard | GridCard | SplitInfo | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitInfoList | SplitRow | SectionHeader | Hero2 | Hero1 | BenefitsType | Media | Statistics | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Product | UserAccount | Testimonial | Faq | Category | Post | Author | SiteSettings | Page | SanityFileAsset | Slug | NavigationMenu | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | ContactInfo | Code;
...
// Source: ./sanity/queries/forms/register.ts
// Variable: REGISTER_QUERY
// Query: *[_type == "page" && slug.current == $slug][0]{  blocks[]{      _type == "form-register" => {    _type,    _key,    padding,    colorVariant,    stackAlign,    title,    description,    privacyPolicyText,    buttonText,    successMessage,    goal  },  }}
export type REGISTER_QUERYResult = {
  blocks: Array<{
    _type: "form-register";
    _key: string;
    ...
    goal: YandexGoal | null;
  } | {}> | null;
} | null;

// Source: ./sanity/queries/page.ts
// Variable: PAGE_QUERY
// Query: *[_type == "page" && slug.current == $slug][0]{    blocks[]{        _type == "hero-1" => {    _type,    _key,    tagLine,    title,    body[]{      ...,      _type == "image" => {        ...,        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        }      }    },    media,    links,    statistics  },        _type == "hero-2" => {    _type,    _key,    tagLine,    title,    body[]{      ...,      _type == "image" => {        ...,        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        }      }    },    links,    image{      ...,      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    },  },        _type == "section-header" => {    _type,    _key,    sectionID,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    description,    link,  },          _type == "breadcrumbs" => {      _type,      _key,      padding,      colorVariant,      crumbs[]->{        _id,        title,        slug      },      hideCurrent,    },        _type == "split-row" => {    _type,    _key,    sectionID,    padding,    colorVariant,    noGap,    splitColumns[]{        _type == "split-content" => {    _type,    _key,    sticky,    padding,    colorVariant,    tagLine,    title,    body[]{      ...,      _type == "image" => {        ...,        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        }      }    },    footerBody[]{      ...,      _type == "image" => {        ...,        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        }      }    },    statistics,    infoList,    benefits,    link,  },        _type == "split-cards-list" => {    _type,    _key,    list[]{      image{        ...,        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        },        alt      },      icon,      tagLine,      title,      body[]{        ...,        _type == "image" => {          ...,          asset->{            _id,            url,            mimeType,            metadata {              lqip,              dimensions {                width,                height              }            }          }        }      },    },  },        _type == "split-image" => {    _type,    _key,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    },    caption{      ...,      _type == "image" => {       ...,        asset->{          _id,          url,        }      }    }  },        _type == "split-info-list" => {    _type,    _key,    gridColumns,    list[]{      image{        ...,        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        },        alt      },      icon,      title,      body[]{        ...,        _type == "image" => {          ...,          asset->{            _id,            url,            mimeType,            metadata {              lqip,              dimensions {                width,                height              }            }          }        }      },      tags[],    },  },    },    link  },        _type == "grid-row" => {    _type,    _key,    padding,    colorVariant,    gridColumns,    featuredProducts[]->{      _id,      name,      "slug": slug.current,      gallery[] {        "url": asset->url,        "alt": alt,        "dimensions": asset->metadata.dimensions      },      price,      currency,      description[] {        ...,        markDefs[] {          ...,          _type == "internalLink" => {            "slug": @.reference->slug.current          }        }      },      specifications[] {        name,        value      },      stock,      isAvailable,      seo {        metaTitle,        metaDescription,        keywords      },      categories[]-> {        _id,        name,        "slug": slug.current      },      tags    },    columns[]{        _type == "grid-card" => {    _type,    _key,    title,    excerpt,    image{      ...,      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    },    link,  },        _type == "pricing-card" => {    _type,    _key,    title,    tagLine,    price,    list[],    excerpt,    link,  },        _type == "grid-post" => {    _type,    _key,    post->{      title,      slug,      excerpt,      image{        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        },        alt      },      categories[]->{        _id,        title,      },    },  },        _type == "grid-product" => {    _type,    _key,    _id,    product-> {      _id,      name,      "slug": slug.current,      gallery[] {        "url": asset->url,        "alt": alt,        "dimensions": asset->metadata.dimensions      },      price,      currency,      description[] {        ...,        markDefs[] {          ...,          _type == "internalLink" => {            "slug": @.reference->slug.current          }        }      },      specifications[] {        name,        value      },      stock,      isAvailable,      seo {        metaTitle,        metaDescription,        keywords      },      categories[]-> {        _id,        name,        "slug": slug.current      },      tags    }  }    },  },        _type == "carousel-1" => {    _type,    _key,    padding,    colorVariant,    size,    orientation,    indicators,    images[]{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    },  },        _type == "carousel-2" => {    _type,    _key,    padding,    colorVariant,    testimonial[]->{      _id,      name,      title,      image{        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        },        alt      },      body[]{        ...,        _type == "image" => {          ...,          asset->{            _id,            url,            mimeType,            metadata {              lqip,              dimensions {                width,                height              }            }          }        }      },      rating,    },  },        _type == "timeline-row" => {    _type,    _key,    padding,    colorVariant,    timelines[]{      title,      tagLine,      body[]{        ...,        _type == "image" => {          ...,          asset->{            _id,            url,            mimeType,            metadata {              lqip,              dimensions {                width,                height              }            }          }        }      },    },  },        _type == "cta-1" => {    _type,    _key,    padding,    colorVariant,    sectionWidth,    stackAlign,    tagLine,    title,    body[]{      ...,      _type == "image" => {        ...,        asset->{          _id,          url,          mimeType,          metadata {            lqip,            dimensions {              width,              height            }          }        }      }    },    links,  },        _type == "logo-cloud-1" => {    _type,    _key,    padding,    colorVariant,    title,    images[]{      ...,      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    },  },        _type == "faqs" => {    _type,    _key,    padding,    colorVariant,    faqs[]->{      _id,      title,      body[]{        ...,        _type == "image" => {          ...,          asset->{            _id,            url,            mimeType,            metadata {              lqip,              dimensions {                width,                height              }            }          }        }      },    },  },        _type == "form-newsletter" => {    _type,    _key,    padding,    colorVariant,    stackAlign,    consentText,    buttonText,    successMessage,  },        _type == "form-register" => {    _type,    _key,    padding,    colorVariant,    stackAlign,    title,    description,    privacyPolicyText,    buttonText,    successMessage,    goal  },        _type == "all-posts" => {    _type,    _key,    padding,    colorVariant,  },    },    meta_title,    meta_description,    noindex,    ogImage {      asset->{        _id,        url,        metadata {          dimensions {            width,            height          }        }      },    }  }
...
// Query: *[_type == "siteSettings"][0]{  ...,  siteContactInfo,  mainNavigation{    ...,    menuItems[]{      ...,      pageReference->{        _id,        title,        "slug": slug.current      }    }  },  footerNavigation[]{    ...,    menuItems[]{      ...,      pageReference->{        _id,        title,        "slug": slug.current      }    }  }}
export type SITE_SETTINGS_QUERYResult = {
  ...
  _updatedAt: string;
  _rev: string;
  siteContactInfo: ContactInfo | null;
  siteLegalInfo?: string;
  paymentMethod?: Array<{
...
// Query: *[_type == "userAccount"]{    userId,    name,    totalAmount,    date    }
...
// Query: *[_type == "userAccount" && userId == $userId][0]{    userId,    name,    date,    totalAmount,    donations[] {        userId,        amount,        date,        email    }    }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"userAccount\" && userId == $userId][0]{\n    userId,\n    name,\n    date,\n    totalAmount,\n    donations[] {\n        userId,\n        amount,\n        date,\n        email\n    }\n    }": USER_BY_ID_QUERYResult;
  }
}
