...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | Geopoint | YandexGoal | Breadcrumbs | AllPosts | FormRegister | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | GridRow | GridProduct | GridPost | PricingCard | GridCard | SplitInfo | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitInfoList | SplitRow | SectionHeader | Hero2 | Hero1 | Media | Statistics | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Product | UserAccount | Testimonial | Faq | Category | Post | Author | Page | SanityFileAsset | Slug | SiteSettings | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | ContactInfo | Code;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"siteSettings\"][0]": SITE_SETTINGS_QUERYResult;
